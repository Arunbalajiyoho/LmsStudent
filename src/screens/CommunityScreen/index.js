  ...
  return (
    <View style={styles.container}>
      ...
      {/* profile details */}
        ...
        <View style={styles.arrowContainer}>
          ...
          <View style={styles.profilepic}>
            ...
            <Text style={styles.Notification1}
            numberOfLines={1}>ArunBalaji,Sanjay,Rajesh,Aravindh,Balaji</Text>
        ...
        renderItem={({ item }) => (
          ...
          <View style={item.user === 'user' ? styles.userMessage : styles.botMessage}>
            {item.user === 'bot' && item.image && (
              <Image source={{ uri: item.image }} resizeMode='cover' style={styles.botProfilePicture} />
            )}
      ...
      <View style={styles.inputContainer}>
        ...
        <FontAwesome name="send-o" size={26} color={COLORS.white}  style={{paddingLeft:5}}/>
        </TouchableOpacity>
      </View>
    </View>
  );
